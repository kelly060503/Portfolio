...
fig.suptitle("歷年結婚人口統計",fontsize=36,color="#0000AA")
cmap1 = mpl.cm.summer([(1-0)/len(df["區域總計"]) * i for i in range(len(df["區域總計"]))])
pt.barh(df["年份"],df["區域總計"],label="總人數",color=cmap1)
pt.set_xlabel("人數",labelpad=-12,x=1.01,fontsize=22,color='#550088')
pt.set_ylabel("年份",labelpad=-16,y=1,fontsize=22,rotation=360,color='#550088')
