...
mpl.rcParams["axes.prop_cycle"] = cycler(markersize=["8","8","8"],marker=["^","D","*"])
...
fig.suptitle("歷年出生人口統計",fontsize=36,color="#0000AA")
pt.plot(df["年份"],df["出生人數(人)"],label="總人數",color="#5599FF")
pt.plot(df["年份"],df["男出生人數(人)"],label="男生",color="#227700")
pt.plot(df["年份"],df["女出生人數(人)"],label="女生",color="#C10066")
